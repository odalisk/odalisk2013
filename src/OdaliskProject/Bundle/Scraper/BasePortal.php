...
use OdaliskProject\Bundle\Scraper\Tools\Normalize\CategoryNormalizer;
...
abstract class BasePortal
{
    ...
    {
        $this->portal = $this->em->getRepository('OdaliskProject\Bundle\Entity\Portal')
    ...
    public function parsePortal()
    {
        ...
        $this->portal = new \OdaliskProject\Bundle\Entity\Portal();
        ...
        $criteria = new \OdaliskProject\Bundle\Entity\PortalCriteria();
