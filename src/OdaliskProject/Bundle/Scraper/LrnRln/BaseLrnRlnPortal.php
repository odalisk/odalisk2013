...
abstract class BaseLrnRlnPortal extends BasePortal
{
    ...
    public function __construct()
    {
        $this->criteria = array(
            ...
            'setReleasedOn' => '//li/strong[.="Publication"]/../text()',
            'setLastUpdatedOn' => '//li/strong[.="Mise à jour"]/../text()',
            'setCategories' => '//li/strong[.="Catégorie "]/../text()',
            'setRawLicense' => '//li/strong[.="Licence"]/../text()',
            'setProvider' => '//li/strong[.="Diffuseur"]/../text()',
            'setOwner' => '//li/strong[.="Propriétaire"]/../text()',
