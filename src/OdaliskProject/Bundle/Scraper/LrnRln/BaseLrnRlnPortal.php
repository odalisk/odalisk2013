...
namespace OdaliskProject\Bundle\Scraper\LrnRln;
...
abstract class BaseLrnRlnPortal extends BasePortal
{
    ...
    {
        $this->criteria = array(
            'setName' => '//div[@id="centre"]/h2/img/@alt',
            'setSummary' => '//div[@id="centre"]/div[@class="left"]/p[2]/text()',
            'setReleasedOn' => '//*[@id="centre"]/div[4]/ul/li[3]/text()',
            'setLastUpdatedOn' => '//*[@id="centre"]/div[4]/ul/li[2]/text()',
            'setCategories' => '//*[@id="centre"]/div[4]/ul/li[7]/text()',
            'setRawLicense' => '//*[@id="centre"]/div[4]/ul/li[10]/text()',
            'setProvider' => '//*[@id="centre"]/div[4]/ul/li[6]/text()',
            'setOwner' => '//*[@id="centre"]/div[4]/ul/li[5]/text()',
